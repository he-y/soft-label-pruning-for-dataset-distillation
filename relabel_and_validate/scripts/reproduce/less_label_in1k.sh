...
LPLD_imagenet_1k_result(){
    ...
    for model_size in 18; do
        ...
        for ratio in 0.975; do
            # pre-defined paths for later generated labels
            ratio_path=$(echo $ratio | sed 's/0\.//g')
            fkd_path="syn_label_LPLD/FKD_cutmix_fp16_LPLD_in1k_rn18_4k_ipc${ipc}_ratio${ratio_path}"
...
LPLD_imagenet_1k_result 20
LPLD_imagenet_1k_result 50
LPLD_imagenet_1k_result 100
LPLD_imagenet_1k_result 200